...
# Add your review:
review = "Natural Language pocessing starts from first cleaning the data, parsing data then using language and topic models to find patterns between words. We can also use text similiarities to predict future words."
